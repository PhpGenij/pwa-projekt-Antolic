...
<?php 
    ...
    <section id="category1" class="news-category">
            ...
            <div class="news-row">
    <?php 
   $query = "SELECT * FROM vrsta WHERE arhiva=0 AND kategorija='sport' ORDER BY id DESC LIMIT 3";
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        <section id="category2" class="news-category">
            <h2>Kultura</h2>
            <div class="news-row">
            <?php 
   $query = "SELECT * FROM vrsta WHERE arhiva=0 AND kategorija='kultura' ORDER BY id DESC LIMIT 3";
    $result = mysqli_query($dbc, $query); 
    $i=0; 
    while ($row = mysqli_fetch_array($result)) {
